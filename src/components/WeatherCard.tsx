  ...
  return (
    <div className="flex flex-col p-4 sm:p-6 bg-gray-700 rounded-2xl border-2 border-violet-900">
      ...
      <div className="flex flex-col p-8 bg-gray-300 shadow-md rounded-2xl text-center">
        ...
        <p className="text-sm sm:text-lg md:text-2xl text-violet-700 mb-2">Humidity: {data.main.humidity}%</p>
        <p className="text-sm sm:text-lg md:text-2xl text-violet-700 mb-2">Pressure: {data.main.pressure} hPa</p>
        <p className="text-sm sm:text-lg md:text-2xl text-violet-700 mb-2">Wind speed: {data.wind.speed} m/s</p>
        <p className="text-sm sm:text-lg md:text-2xl text-green-700 mb-2">Feels like: {data.main.feels_like}°C</p>
      </div>
    </div>
  )
}
